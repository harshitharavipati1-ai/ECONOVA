          ...
          {activeTab === 'login' && (
            <form onSubmit={handleLoginSubmit} className="space-y-4">
              ...
              <div className="p-3.5 rounded-xl bg-slate-900 text-slate-100 border border-slate-800 flex items-start gap-3">
                <div className="p-2 rounded-lg bg-emerald-500/20 border border-emerald-500/30 text-emerald-400 mt-0.5">
                  <Key className="w-4 h-4" />
                </div>
                <div className="text-xs space-y-1">
                  <p className="font-bold text-emerald-400">Military-Grade PBKDF2 / SHA-256 Salted Authentication</p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 max-h-36 overflow-y-auto pr-1">
                    {existingUsers.map((u) => (
                      <button
                        ...
                        className="p-2.5 rounded-xl border border-slate-200 hover:border-emerald-400 hover:bg-emerald-50/50 text-left transition-all flex flex-col justify-between"
                      >
                ...
                <div>
                  ...
                  <div className="mt-1.5">
                    ...
                    <span className="text-[10px] text-slate-500 mt-1 block">
                      Strength: <strong className="text-slate-700">{currentRegPwStrength.label}</strong>
                    </span>
                  </div>
                </div>
